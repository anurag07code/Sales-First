...
export const MOCK_COMPANY_DETAILS = {
  "1": {
    ...
    description: "TechCorp Global is a leading provider of enterprise software solutions, specializing in cloud infrastructure, AI-powered analytics, and digital transformation services. With over 50,000 employees worldwide, the company serves Fortune 500 clients across multiple industries.",
    news: [{
    ...
    keyCustomers: ["Goldman Sachs", "General Electric", "Siemens", "Toyota", "Volkswagen", "Shell Energy"],
    stockData: [{
      date: "Jan",
      value: 145
    }, {
...
export const MOCK_RFP_PROJECTS = [{
  ...
  tabs: [{
    ...
    sections: [{
      heading: "Objectives",
      content: "Complete migration of legacy systems to cloud infrastructure with integrated AI analytics capabilities. Modernize 15+ applications serving 10,000+ users globally."
    }, {
      heading: "Technical Requirements",
      content: "Multi-cloud architecture (AWS, Azure), microservices design, API-first approach, real-time data processing, advanced security protocols (SOC 2, ISO 27001 compliance)."
    }, {
      heading: "Deliverables",
      content: "Fully migrated cloud infrastructure, custom AI analytics dashboard, comprehensive documentation, training materials, 12-month support plan."
    }]
  }, {
    ...
    sections: [{
      ...
      content: "12-15 FTE: Cloud architects (3), Backend developers (4), AI/ML engineers (2), DevOps (2), QA (2), Project Manager (1)."
    }, {
      heading: "Technology Stack",
      content: "AWS/Azure, Kubernetes, Python, Node.js, TensorFlow, React, PostgreSQL, Redis."
    }]
  }, {
    ...
    sections: [{
      ...
      content: "Data migration integrity, system downtime during cutover, integration with legacy APIs."
    }, {
      ...
      content: "Phased rollout approach, comprehensive testing protocols, dedicated change management team, contingency budget allocation."
    }]
  }],
  journeyBlocks: [{
    name: "RFP Received",
  ...
  tabs: [{
    ...
    sections: [{
      heading: "Objectives",
      content: "Implement comprehensive ERP solution with digital transformation initiatives. Integrate 20+ business systems and streamline operations across 5 divisions."
    }, {
      heading: "Technical Requirements",
      content: "SAP S/4HANA implementation, API gateway, data warehousing, business intelligence platform, mobile applications."
    }, {
      heading: "Deliverables",
      content: "Fully integrated ERP system, BI dashboards, mobile apps, training program, 18-month support."
    }]
  }, {
    title: "Timelines & Milestones",
    icon: "Calendar",
    ...
    sections: [{
      ...
      heading: "Team Composition",
      content: "18-20 FTE: SAP consultants (5), Integration specialists (4), BI developers (3), QA (3), Change management (2), Project Manager (1)."
    }, {
      heading: "Technology Stack",
      content: "SAP S/4HANA, SAP Fiori, SAP BW/4HANA, SAP PI/PO, Tableau, Azure cloud."
    }]
  }, {
    title: "Risk & Complexities",
    icon: "AlertTriangle",
    sections: [{
      heading: "Technical Risks",
      content: "Complex data migration from legacy systems, integration challenges, performance issues."
    }, {
      heading: "Business Risks",
      content: "User resistance to change, business process disruption, timeline delays."
    }, {
      heading: "Mitigation Strategies",
      content: "Phased implementation, comprehensive training, dedicated support team, change management program."
    }]
  }],
  journeyBlocks: [{
    name: "RFP Received",
  ...
  tabs: [{
    ...
    sections: [{
      heading: "Objectives",
      content: "Deploy enterprise-grade cybersecurity platform with compliance monitoring. Protect infrastructure and ensure GDPR, HIPAA, and SOX compliance."
    }, {
      heading: "Technical Requirements",
      content: "SIEM platform, threat intelligence, endpoint protection, identity management, compliance automation tools."
    }, {
      heading: "Deliverables",
      content: "Security operations center setup, compliance dashboard, incident response framework, security training, 24/7 monitoring."
    }]
  }, {
    title: "Timelines & Milestones",
    icon: "Calendar",
    ...
    sections: [{
      ...
      heading: "Team Composition",
      content: "8-10 FTE: Security architects (2), Security analysts (3), Compliance specialists (2), Project Manager (1)."
    }, {
      heading: "Technology Stack",
      content: "Splunk, CrowdStrike, Okta, Qualys, Microsoft Defender, Compliance automation tools."
    }]
  }, {
    title: "Risk & Complexities",
    icon: "AlertTriangle",
    sections: [{
      heading: "Technical Risks",
      content: "Integration complexity, false positives, performance impact on systems."
    }, {
      heading: "Business Risks",
      content: "Regulatory changes, evolving threat landscape, resource constraints."
    }, {
      heading: "Mitigation Strategies",
      content: "Staged rollout, continuous monitoring, regular updates, dedicated security team."
    }]
  }],
  journeyBlocks: [{
    name: "RFP Received",
