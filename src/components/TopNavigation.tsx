        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          >
            <div className="relative">
              ...
              <div 
                className="absolute inset-0 rounded-full animate-ping opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex items-center gap-3">
              ...
              <Button
                variant="ghost"
                className="text-sm font-medium transition-all duration-300 hover:bg-accent/50 hover:scale-105"
              >
                Login
              </Button>
            </div>
