...
const FeatureCards = () => {
  ...
  const flowTooltips = [
    "Brand Analysis provides deep insights into companies",
    "Data from Brand Analysis automatically seeds RFP insights",
    "RFP data flows into contract review and risk assessment",
  ];
      ...
      <div className="relative">
        ...
        >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <line
                ...
                strokeWidth="1"
                strokeDasharray="4 4"
                className="animate-pulse-glow hover:stroke-foreground cursor-pointer transition-all pointer-events-auto"
          ...
          <polygon
            ...
            fill="hsl(0 0% 70%)"
            opacity="0.4"
            transform="translate(calc(50% - 5), 42%) rotate(90)"
          />
          <polygon
            points="0,0 10,5 0,10"
            fill="hsl(0 0% 70%)"
            opacity="0.4"
            transform="translate(calc(50% - 5), 75%) rotate(90)"
          />
        </svg>
              ...
              <Card className="group relative overflow-hidden gradient-card border border-border hover:border-foreground/20 transition-all duration-300 hover:shadow-elegant hover:scale-[1.01]">
                <div className="relative p-6 space-y-4">
                  <div className="flex items-start justify-between">
                    ...
                    {feature.isFlow && (
                      <div className="px-2 py-1 rounded-full border border-border text-muted-foreground text-xs font-medium">
                        Core Flow
                      </div>
                    )}
                  </div>
