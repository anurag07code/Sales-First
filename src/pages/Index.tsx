...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ backgroundColor: '#FFFFFF' }}>
      ...
      {/* Metrics Section */}
      <section className="py-16 border-y border-border" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {metrics.map((metric, index) => (
              <Card
                key={index}
                className="text-center group cursor-pointer p-6 rounded-xl border-2 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:-translate-y-1"
                style={{ 
